package java_lang_programming.com.android_service_demo;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        umgBtn = (Button) findViewById(R.id.umg_btn);
        umgBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                moveMediaShowActivity();
            }
        });

        cpgBtn = (Button) findViewById(R.id.cpg_btn);
        cpgBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    /**
     * transfer to MediaShowActivity
     */
    private void moveMediaShowActivity() {
        Intent intent = new Intent(this, MediaShowActivity.class);
        startActivity(intent);
    }

    /**
     * transfer to ContentProviderVideoActivity
     */
